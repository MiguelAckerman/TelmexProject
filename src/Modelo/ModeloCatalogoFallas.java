...
public class ModeloCatalogoFallas {
	...
	public int AgregarFalla(CatalogoFalla pFalla){
		...
		if (conexion != null ) {
			...
			try {
				...
				return x;
				//SI HUBO CONEXI�N Y SE EJECUTO EL QUERY CON EXITO
	...
	{
		String columnas [] = {"Codigo","Descripci�n"};
	...
	public String [] consultaDatos(String codigo)
	{
		...
		return null;
	}//REGRESAMOS LA DESCRIPCI�N DE LA FALLA SEGUN SEA EL CODIGO POR EL CUAL SE BUSCA
